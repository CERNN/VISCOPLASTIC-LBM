...
//Mindlin theory 1949
constexpr dfloat PP_STIFFNESS_TANGENTIAL_CONST =  8.0 / ((2-PARTICLE_POISSON_RATIO)/PARTICLE_SHEAR_MODULUS + (2-PARTICLE_POISSON_RATIO)/PARTICLE_SHEAR_MODULUS);
constexpr dfloat PW_STIFFNESS_TANGENTIAL_CONST =  8.0 / ((2-PARTICLE_POISSON_RATIO)/PARTICLE_SHEAR_MODULUS + (2-WALL_POISSON_RATIO)/WALL_SHEAR_MODULUS);
// Tsuji 1979
