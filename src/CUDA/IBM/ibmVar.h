...
constexpr FRICTION_COEF_CORRECTED = 1/((16.21*REST_COEF+15.58*REST_COEF*REST_COEF*REST_COEF)/((1-REST_COEF*REST_COEF)*(1-REST_COEF*REST_COEF)+(5.53*REST_COEF)*(5.53*REST_COEF)));
#endif 
